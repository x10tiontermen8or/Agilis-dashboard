...
import { Camera, Maximize2, Settings, VolumeX, Volume2 } from "lucide-react";
...
// 👇 The 'export' keyword is the important part
        ...
        <Card>
            ...
            <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {feeds.map((feed) => (
                        <div key={feed.id} className="relative group cursor-pointer" onClick={() => setSelectedFeed(selectedFeed === feed.id ? null : feed.id)}>
